...
for branch in $SORTED; do
  ...
  if [ $branch = "main" ]; then
    echo "    <td nowrap class=\"bg\"><a href=\"https://author-tools.ietf.org/iddiff?url_1=https://netmod-wg.github.io/yang2-and-friends/main/rfc7950.txt&url_2=https://netmod-wg.github.io/yang2-and-friends/main/draft-yn-netmod-yang2-00.txt\">Diff with RFC7950</a><!--<br><a href=\"https://author-tools.ietf.org/api/iddiff?doc_1=draft-yn-netmod-yang2&url_2=https://netmod-wg.github.io/yang2-and-friends/main/draft-yn-netmod-yang2-00.txt\"><s>Diff with Datatracker</s></a>--> </td>" >> index.html
  else
    echo "    <td nowrap class=\"bg\"> <a href=\"https://author-tools.ietf.org/api/iddiff?url_1=https://netmod-wg.github.io/yang2-and-friends/$BASE/draft-yn-netmod-yang2-00.txt&url_2=https://netmod-wg.github.io/yang2-and-friends/$branch/draft-yn-netmod-yang2-00.txt\">Diff with Main</a> </td>" >> index.html
  fi
  echo "  </tr>" >> index.html
done
