...
for branch in $SORTED; do
  ...
  if [ $branch = "main" ]; then
    ...
    echo "    <td nowrap class=\"bg\"> <a href=\"https://author-tools.ietf.org/api/iddiff?url_1=https://netmod-wg.github.io/yang2-and-friends/$BASE/draft-yn-netmod-yang-2-00.txt&url_2=https://netmod-wg.github.io/yang2-and-friends/$branch/draft-yn-netmod-yang-2-00.txt\">Diff with Base</a> </td>" >> index.html
  fi
  echo "  </tr>" >> index.html
done
